...
<?php
    ...
    $paykassa = new \App\CloudEx\paykassa\src\PaykassaSCI(
    ...
    if ("GET" === $_SERVER['REQUEST_METHOD']) {
        $list = \App\CloudEx\paykassa\src\PaykassaSCI::getPaymentSystems("crypto");
?>
...
<?php
    ...
    $paykassa = new \App\CloudEx\paykassa\src\PaykassaAPI(
...
<?php
    ...
    $res = \App\CloudEx\paykassa\src\PaykassaCurrency::getCurrencyPairs($pairs);
